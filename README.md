...
下载：https://github.com/2099742859-lgtm/server-monitor/releases/download/v1.1/server-monitor.bat
...
下载：https://github.com/2099742859-lgtm/server-monitor/releases/download/v1.1/server-monitor.sh

```bash
curl -fsSL -o server-monitor.sh https://github.com/2099742859-lgtm/server-monitor/releases/download/v1.1/server-monitor.sh
...
Download: https://github.com/2099742859-lgtm/server-monitor/releases/download/v1.1/server-monitor.bat
...
Download: https://github.com/2099742859-lgtm/server-monitor/releases/download/v1.1/server-monitor.sh
